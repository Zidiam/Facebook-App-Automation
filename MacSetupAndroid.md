# Mac/Android Tutorial:

This code will test Facebooks apps features on Android on Mac OS. This will use Jest for the testing. Appium and WebDriverIO is for automating the tasks.
